...
Two middleware functions are provided by default in the `web.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `web.handler` namespace to manage the enabled middleware.
